%What was changed compared to the original:
...
% Broken into \LaTeX by me.
% Originally written by Thayer, Ella Cheever, 1849-1925.

%Here are some options to choose from, change between false and true

%Controls if the chapters break or not break the page. No Page Break is not native to this Latex document class, so they require some additional hardcoded \clearpage. (Honestly, maybe nopagebreak could be done better on my part). Make sure to check all the chapters rendering correctly.
\newif\ifChapterNoPageBreak
\ChapterNoPageBreakfalse

%Initials style. Pick only one or the last one will be selected only. There is a choice of original initials (require initials .png files in the project folder) which is default. Gothic initials, and plain text initials. Please choose only one. It is easy to choose your own font using gothic as an example.
\newif\ifOriginalInitials
\OriginalInitialstrue
\newif\ifPlainInitials
\PlainInitialsfalse
\newif\ifGothicInitials
\GothicInitialsfalse




%To make it into printable pdf with signatures make a new project, add to it rendered pdf and paste into main.tex. You might need to change the pdf name in code. You can set signature number. And hope the compilation does not time out.
...
%%Thank you sirjofri from https://tex.stackexchange.com/a/286278

%One a page size of your choosing (likely A4 for print, resulting in A5 book) print doublesided, rotating around shorter edge. I recommend printing the first piece of paper and then try to make the sense out of the signature stacking to make sure print settings are correct.



%Below font, fontsize, papersize and margins can be altered
...
\newcommand{\decorule}{\rule{35pt}{1pt}\resizebox{0.33ex}{!}{\hspace{-2pt}\raisebox{-0.475ex}{$\blacklozenge$}}\hspace{-2pt}\rule{35pt}{1pt}}



%Morse
\newlength{\munit} %one space
\setlength{\munit}{0.5ex}
\newlength{\mthickness} %dot/dash thickness
\setlength{\mthickness}{0.6ex}
\newcommand{\mdot}{\raisebox{0.4ex}{\rule{\munit}{\mthickness}}}
\newcommand{\mdash}{\raisebox{0.4ex}{\rule{3\munit}{\mthickness}}}
\newcommand{\mintra}{\hspace{\munit}}   % 1 space  between dot/dash
\newcommand{\minter}{\hspace{3\munit}}  % 3 spaces between letters
\newcommand{\mword}{\hspace{7\munit}}   % 7 spaces between words

%At the very end of a document there are rules for regex translating uppercased text to above morse syntax (which can be translated to other syntaxes)
...
\ifnum\value{chapter}=1
    \LARGE{\textls[200]{WIRED LOVE}.}\\
    \ifChapterNoPageBreak
    \vspace{6ex}
    \else
    \vspace{2ex} \decorule\vspace{3ex}\\*
    \fi
\fi
\ifChapterNoPageBreak
\vspace{-4ex} \decorule\vspace{3ex}\\*
\fi
\large{CHAPTER  \thechapter.}
} % label
{3ex} % sep
{\normalsize\centering} % before-code
[\vspace{-3.5ex}] % after-code
...
\fi
\begin{noclearpage}
\chapter[#1]{#2}\markboth{#3}{#3}\thispagestyle{empty}
\end{noclearpage}
\ifChapterNoPageBreak
\fi}
...
\ifOriginalInitials
    \DeclareRobustCommand{\initial}[1]{%
      \StrRight{#1}{1}[\c]%
      \includegraphics[height=0.75\baselineskip]{\c.png}%
    }
    \newcommand{\mylettrine}[3][]{%
      \lettrine[#1, lines=3, lraise=-0.1]{\initial{#2}}{#3}%
    }
\fi
\ifGothicInitials
    \usepackage{oldgerm}
    \renewcommand{\LettrineFontHook}{\gothfamily}
    \newcommand{\mylettrine}[3][]{\lettrine[#1, lines=3, lraise=0.15]{\scalebox{1.7}[1.7]{#2}}{#3}}
\fi
\ifPlainInitials
    \newcommand{\mylettrine}[3][]{%
      \lettrine[#1, lines=3, lraise=0]{#2}{#3}%
}
\fi

%A paragraph skip for situations where first line of a chapter is very short. Requires hardcoding but should work fine.
\def\Fparn{\hfil\vadjust{\vskip\parskip}\break\noindent} % <=== thank you random person on stackoverflow

\newcommand{\myquoteante}{%
  \kern-1.0\fontcharht\font`A % horizontal shift relative to current font
  \raisebox{-0.5\baselineskip}{\scalebox{1.85}{``}} % vertical shift + scaling relative to line height
  \kern-0.7\fontcharht\font`A % horizontal shift relative to current font
...
DOTS AND DASHES\\
\vspace{30pt}
\large{``The old, old story,''--in a new, new way.}}
\author{
\small{BY}\\
ELLA CHEEVER THAYER}
...
\vspace{0.75ex}\\
NEW YORK:\\
\large{W. F. Johnston, Publisher,}\\
\small{No. 9 MURRAY STREET.}\\
\small{MDCCCLXXX}}%1880}
...
\begin{center}
\bfseries
\phantom{\footnotemark[0]{}}DEDICATION.\footnotemark
    
\mdash\mintra\mdot\mintra\mdot\minter\mdot\minter\mdash\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\minter\mdash\mintra\mdot\mintra\mdash\mintra\mdot\mintra\mdash\minter\mdot\mintra\mdash\minter\mdash\minter\mdot\minter\mdash\mintra\mdot\mintra\mdot

\mdash\minter\mdash\mintra\mdash\mintra\mdash

\mdash\minter\mdot\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdot\mword\mdash\mintra\mdash\minter\mdot\minter\mdash\mintra\mdash\minter\mdash\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdash\mintra\mdot\minter\mdash\mintra\mdot\mintra\mdash\mintra\mdash

\mdash\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdot\mintra\mdash\mintra\mdot\mword\mdot\mintra\mdash\mword\mdash\mintra\mdot\mintra\mdot\minter\mdot\minter\mdot\mintra\mdash\minter\mdot\mintra\mdash\mintra\mdot

\mdot\mintra\mdot\mintra\mdash\mintra\mdot\minter\mdot\mintra\mdash\mintra\mdot\minter\mdot\mintra\mdot\minter\mdot\minter\mdash\mintra\mdot\minter\mdash\mintra\mdot\mintra\mdot\mword\mdash\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\mintra\mdash\minter\mdash\mword

\mdot\mintra\mdot\mintra\mdash\mintra\mdot\minter\mdash\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdash\mintra\mdot\mword\mdot\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdash\mintra\mdash\mintra\mdash\minter\mdash\mintra\mdash\mword

\mdash\minter\mdot\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\minter\mdot\mintra\mdot\mintra\mdot\mword\mdot\mintra\mdash\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\minter\mdash\minter\mdash\minter\mdot\mintra\mdash\mintra\mdot\mintra\mdot\minter\mdot

\mdot\mintra\mdash\mintra\mdash\minter\mdash\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdash\mintra\mdot\minter\mdash\mintra\mdot\mintra\mdash\mword\mdot\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdash\minter\mdash\mintra\mdot\mintra\mdot\mword

\mdash\mintra\mdot\minter\mdot\minter\mdot\mintra\mdot\mintra\mdot\mintra\mdash\minter\mdot\minter\mdot\mintra\mdash\mintra\mdot\mword\mdash\mintra\mdot\mintra\mdot\mintra\mdot\minter\mdot\minter\mdot\minter\mdash\mintra\mdot
% DEDICATION
% \morse{TO}
% \morse{THE MEMORY}\\
% \morse{OF A DEAR}\\
...
\footnotetext{Morse code table can be found on page~\pageref{MorseTable}.}
\newpage
\thispagestyle{empty}
\cleardoublepage
...
\mychapter{Sounds from a Distant ``C''}{SOUNDS FROM A DISTANT ``C.''}{Sounds from a Distant ``C.''}

\begin{center}
\mdash\mintra\mdot\mintra\mdot\mintra\mdot\mword\mdash\mintra\mdash\mword\mdot\mintra\mdash\mintra\mdot\mintra\mdot\mword\mdash\mintra\mdot
% -... -- .-.. -.
\end{center}

\mylettrine{J}{ust} a noise, that is all.\Fparn%hardcoded
...
For who but an operator very green in the profession would stay \emph{there}?
...
To convert a \emph{horse} into a hearse is really an idea that merits a smile!''
...
``But I am quite sure you can, with propriety be called \emph{Mr.} `C '--plain,
...
although our acquaintance had a \emph{grave re-hearse}-al, I trust it will have
a happy ending!''

Nattie frowned.

``If you will promise never to say `\emph{grave},' `\emph{hearse,}' or anything in the
undertaking line, I will agree never to say `cross!' she said.

``The \emph{undertaking} will not be difficult; with all my heart!'' ``C''
...
\mychapter{At the Hotel Norman}{AT THE HOTEL NORMAN.}{At the Hotel Norman.}


\mylettrine{M}{iss} Nattie Rogers, telegraph operator, lived, as it were, in two
...
I should be willing to acknowledge regarding Mrs. Simonson's \emph{other}
...
specimen of the \emph{genus homo}, with a somewhat startling habit of exploding
...
contemplated the possibility of \emph{his} becoming that other self not yet
attained?
...
``What \emph{is} the matter now?'' screamed Miss Kling, appearing at her door
with the query.
...
\emph{would} appear as a tight-rope performer to his perturbed imagination.
...
gentleman, he \emph{was} many miles away. For Quimby, with all his obtusity,
...
\mychapter{Visible and Invisible Friends}{VISIBLE AND INVISIBLE FRIENDS.}{Visible and Invisible Friends.}


\mylettrine{W}{ith} perhaps one or two less frowns than usual at the destiny that
...
that one about the early bird and the worm. But I fear, as a \emph{mys}tery,
you are not a success, \emph{Mr.} `C'.''

``A very bad attempt at a pun,'' said ``C.'' ``I trust, however, you will not
desert me, now your curiosity is satisfied, Miss `N.'?''

``Don't be in such a hurry to \emph{miss} me. I have said nothing yet to give
you that right,'' Nattie replied.

``Nevertheless, it's utterly impossible not to miss you. I missed you
last night after you had gone home, for instance. ``But \emph{you}, a great,
...
``There must be something wrong about a young woman who has \emph{three} immense
trunks!''
...
never can read \emph{that!} I shall have to write it myself. He knows my
writing!'{}''

``Can such things be!'' cried Miss Archer.

``But,'' asked Quimby, from his uncomfortable perch on the edge of the
chair, ``Isn't there a--a something--a \emph{fac-simile} arrangement?''
...
to \emph{that}, you know--that some day I shall marry the wrong woman!''
...
must bid you good-night, with the advice, watch for that \emph{twinkle}, and be
...
\mychapter{Neighborly Calls}{NEIGHBORLY CALLS.}{Neighborly Calls.}


\mylettrine{I}{n} the opinion of Miss Betsey Kling, a lone young woman, who possessed
...
in a public position. Can you imagine \emph{me} upon the stage?'' concluded Miss
...
share of the commodity known as \emph{gush}, was ready enough to be the
...
delivered it read, `John is dead \emph{beat}; home at three.'{}''
...
\mychapter{Quimby Bursts Forth in Eloquence}{QUIMBY BURSTS FORTH IN ELOQUENCE.}{Quimby Bursts Forth in Eloquence.}


\mylettrine[ante=\myquoteante]{T}{hat} young lady over there acts very strangely. She is not crazy, is
...
\mychapter{Collapse of the Romance}{COLLAPSE OF THE ROMANCE.}{Collapse of the Romance.}


\mylettrine[ante=\myquoteante]{B}{M}--B m--B m--N--N--N--Oh! where are you, N? Where is the little girl at
B m--B m--B m?''\Fparn%hardcoded
...
``I did not think you would be so bashful, after all our talks. \emph{I} am
...
all, was not ``C,'' \emph{her} ``C,'' the ``C'' whom she knew by his conversation
...
``I suppose no one really means what they say on the wire. I am sure \emph{I} do
not!''
...
\mychapter{``Good-By''}{``GOOD-BY.''}{``Good-By.''}


\mylettrine{I}{t} was a very long face that Nattie carried to the Hotel Norman that
...
as she recalled his \emph{tout ensemble}.
...
never used to be busy \emph{always}, you know!''
...
deign me no explanation--I will say, not as I would once, \emph{au revoir}, but
good-by.''
...
\mychapter{The Feast}{THE FEAST.}{The Feast.}


\mylettrine{P}{ondering} discontentedly over the perplexities of life, a habit she had
...
But this, of course, was impossible for \emph{him}!
...
\emph{that}, I assure you; the truth is, I am ambitious, Cyn. I suppose I
...
years wasted in vain longings for the then unattainable. \emph{That} is my
...
``Poor child,'' said Cyn, with mock seriousness, ``this \emph{is} coming from the
...
``But the tomato! what \emph{can} we pour that in?'' suddenly exclaimed Nattie,
with great concern.
...
quite \emph{recherche}. But my dear Nat, where am I to set the steak if you
...
than one quart of the tomatoes, and there are \emph{three} of us, you know--the
Duchess!''
...
\mychapter{Unexpected Visitors}{UNEXPECTED VISITORS.}{Unexpected Visitors.}


\mylettrine[ante=\myquoteante]{I}{t} must be Miss Kling, overpowered by curiosity!'' murmured Nattie.\Fparn%hardcoded
...
Quimby. This, however, might not have much disconcerted them, as \emph{he}
...
``No!'' he cried, in stentorian tones, ``it was not--I \emph{cannot} have made a
...
reminding you, you have \emph{not} introduced,'' and Cyn looking laughingly at
...
``It is--\emph{was Charlotte Russe!}'' said Nattie, in gloomy despair.

``\emph{Charlotte Russe!}'' echoed Quimby, still turning himself around like a
...
\mychapter{The Broken Circuit Reunited}{THE BROKEN CIRCUIT RE-UNITED.}{The Broken Circuit Re-united.}


\mylettrine{M}{r.} Stanwood sat down at the table where Nattie was looking over Cyn's
...
\emph{vis-a-vis}, who kept his eyes on his book with the most innocent
...
'\emph{C}' the point? Can't you `C' that you did not `C' the `C' you thought
you did `C' that day?''
...
``Well,'' she exclaimed, ``this \emph{is} a pretty piece of business, never yet
...
``A mistake!'' she repeated excitedly, ``what \emph{do} you mean? YOU `C,' our
...
``How little \emph{I} thought it!'' groaned Quimby, as his hand fell dejectedly
from Clem's shoulder. ``But I--I am used to it, you know!'' So saying he
sank into a chair. That \emph{he} had brought about such a result as
this--that \emph{he} had resurrected the dreaded ``C'' from the grave of musk
...
``Upon \emph{us}, you mean,'' corrected Clem.

``Certainly; upon \emph{us},'' Nattie replied, with another flush of color. ``I
...
``Jo is ready to draw anything. \emph{But} Jo is aghast and horrified at being
...
taking undue advantage of a fellow. A \emph{wired} romance is something
entirely unexpected!''
...
had never held for \emph{him}. Nor could he fail to think, that the romantic
...
unexpected and happy \emph{denouement}, or even that Nattie's sleep would not
...
to be sure no one shall again usurp my place; until then, \emph{au revoir}!''
...
\mychapter{Miss Kling Telegraphically Baffled}{MISS KLING TELEGRAPHICALLY BAFFLED.}{Miss Kling Telegraphically Baffled.}


\mylettrine{M}{iss} Betsey Kling was quite uneasy in her mind about this time, not only
...
``And I suppose \emph{he} and that Quimby are in there with them every evening,
...
From Celeste, she learned that they had ``\emph{such} nice times!'' that Mr.
Stanwood was ``\emph{so} splendid!'' and that ``Miss Archer was just \emph{dead} in
...
agreeable at a \emph{distance}. But--'' said Clem, with a shrug of his
...
``It \emph{is} nicer talking on the wire, isn't it?''
...
those old confidential chats with ``C,''--which \emph{nobody} could share--and
...
``\emph{If} we can!'' Nattie replied with emphasis.
...
was solid work, and \emph{not} romantic, and by Quimby, who viewed the
...
``It doesn't make \emph{me} cross, I--I assure you; it--it will be a pleasure!''
...
been pulling, into his pocket to cool. It \emph{did} cool, but he sold the coat
...
\mychapter{Crosses on the Line}{CROSSES ON THE LINE.}{Crosses on the Line.}


\mylettrine{I}{t} happened that not long after Cyn sang at a concert given in one of
...
``How can she appear before the public so? it seems \emph{so} unwomanly!''
...
Was Clem presuming on his good looks, and thinking of making Cyn \emph{his},
he wondered? If he was, \emph{she} certainly would not be fool enough to--Jo
...
must be always thus? I \emph{cannot} be contented!''
...
annoy you? Poor little girl, it \emph{is} a monotonous life!''
...
\emph{you} could never expect me to compare with her!''
...
Miss Archer is willing he should come home with \emph{you}. She isn't, of
course, jealous of \emph{you!}''
...
lights were out, and all was darkness. \emph{If} he loved Cyn? Nattie, with the
...
and swollen eyes that gazed at her from the opposite glass. ``Life \emph{shall}
...
\mychapter{The Wrong Woman}{THE WRONG WOMAN.}{The Wrong Woman.}


\mylettrine{S}{omewhat} exultant over the new aspect of affairs, and unable longer to
...
understood by \emph{her}, at the same time relating his former unfortunate
attempt.
...
``With Cyn, \emph{too}?'' These words were balm to the soul of Quimby, and gave
him courage to answer eagerly,

``Ah! no use in that for \emph{me}, you know! It--it is \emph{she}--Miss
...
``No--no--I--\emph{No!}'' cried Quimby in great alarm at this proposition. ``She
...
``I--I beg pardon. Is it \emph{you}?'' the shadow asked with accents of delight.
...
from the dilemma into which he was rushing; ``what \emph{can} I do? oh! if Cyn
would only come!''
...
``Ah! really I--such a trying moment!--but dear, \emph{dear} Quimby, I never
...
``I will--I will write and tell you all--\emph{all!} I have an engagement now
...
was the voice of Fishblate \emph{pere}, and it said,
...
``Excuse his eccentricity, Pa!'' Celeste said. ``He loves me \emph{so} much, poor
fellow!''

``Humph! Get enough of \emph{that!}'' he growled, with contempt.

``And he has a nice little property!'' added Celeste, as they went up
stairs.

``Property is the thing!'' Fishblate \emph{pere} said, with undisguised
plainness.
...
\mychapter{Quimby Accepts the Situation}{QUIMBY ACCEPTS THE SITUATION.}{Quimby Accepts the Situation.}


\mylettrine{W}{hen} Quimby rushed out into the street, it was with some wild and
...
``\emph{What!}'' shouted Clem, stopping short in his promenade.
...
``Miss Rogers!--No! never--never! but \emph{she}--Celeste!''
...
I could not think \emph{that!}'' said Quimby, loyally; then with sudden
...
\mychapter{One Summer Day}{ONE SUMMER DAY.}{One Summer Day.}


\mylettrine{T}{he} week that decided Quimby's fate so unexpectedly and brought him so
...
\emph{not} engaged!--''I must say, now that you are speaking of her, that she
does \emph{Kling} in a way that is not pleasant sometimes. She actually annoys
pa!''

``I thought she entertained a high regard for The Tor--for your father,''
said mischievous Cyn.

``That is exactly it!'' replied Celeste. ``\emph{Too} high a regard! Truly, she
...
``\emph{We} are an exception, then, to the general rule!'' simpered Celeste.

Quimby groaned, and then murmured something about the toothache.

``Poor fellow!'' said Cyn, in a low voice, to Nattie.

``After all, there \emph{is} something in fate,'' Nattie sighed.
...
``And get snubbed for my pains!'' muttered Clem, \emph{sotto voce}. But Nattie
...
``I am sorry we have no \emph{Charlotte Russes} to-day, Quimby,'' remarked Clem,
...
that his clothes were shrinking on him as they dried, to divert \emph{him}, and
...
``It has never been \emph{my} wish that any coldness should come between us; you
...
``You--you love--and \emph{love me!}'' she gasped.
...
``Jo, I wish--yes! I \emph{do} wish that I could love you as you deserve to be
...
``\emph{Clem} who stands between us!'' echoed Cyn, astounded for the second time
that day.
...
\emph{me}, a nice predicament we will all be in. But you must be mistaken! I
cannot believe him capable of such a thing! The only reason I have to
fear it is that I would not have credited it of \emph{you} yesterday!''
...
that you--that you--\emph{you}, the gayest of the gay--that \emph{you}--'' Jo stopped,
unable to proceed.

``You hardly expected to find me in the \emph{role} of the victim of a broken
...
``He happened to be one of the kind who \emph{could}. I never really knew the
cause--it might have been another woman. You know there always \emph{is}
another woman.''
...
\mychapter{O. K.}{O. K.}{O. K.}


\mylettrine{L}{eaving} Clem, on their arrival at the hotel, to bear the burden of the
...
``And \emph{I} have curtailed you down to Nat!'' said Cyn, with whimsical
...
know \emph{all}! I pass over the audacity of such proceedings on \emph{my} premises,
...
had it been the bed-room of \emph{one} young man? Nattie, who had flushed
...
suppose, did it. The idea originated with you, of course. \emph{He} hasn't
brains enough; if he had he would not marry Celeste!'' and Miss Kling
sniffed in utter contempt of poor Quimby.

``Thanks for the compliment to \emph{my} intellectual abilities!'' said Clem with
...
``You ought, certainly, to be well informed on the subject of \emph{old}
females who run after \emph{old} men!'' she said, witheringly. ``If one may
...
``And had it not been for that \emph{dear} Betsey Kling with her invectives we
...
``It \emph{was} effective, I flatter myself,'' Cyn confessed. ``And that reminds
...
``And it \emph{will} be written, now, I know!'' said Nattie, earnestly, her eyes
...
\begin{center}
\mdash\mintra\mdash\minter\mdash\mintra\mdot\mintra\mdash\mintra\mdash\mword\mdot\mintra\mdash\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\minter\mdash\minter\mdash\minter\mdot\mintra\mdash\mintra\mdot\mintra\mdot\minter\mdot

\mdash\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdash\minter\mdot\mintra\mdash\mintra\mdot\minter\mdot\mintra\mdash\mintra\mdot\mintra\mdot\minter\mdot\mintra\mdot\minter\mdash\mintra\mdot\minter\mdash\mintra\mdash\mintra\mdot

\mdash\mintra\mdash\minter\mdash\mintra\mdot\mintra\mdash\mintra\mdash\mword\mdot\mintra\mdash\mintra\mdash\minter\mdot\mintra\mdot\minter\mdot\mintra\mdot\mintra\mdash\mintra\mdot\minter\mdot
\end{center}
% MY LITTLE
% DARLING
% MY WIFE
...
\markboth{International Morse Code}{INTERNATIONAL MORSE CODE}  % updates running headers

\begin{center}
\large
\MakeUppercase
INTERNATIONAL MORSE CODE\label{MorseTable}
\vspace{2ex}
\normalsize
...
\begin{tabular}{@{}l l@{}}
A & \mdot\mintra\mdash \\
B & \mdash\mintra\mdot\mintra\mdot\mintra\mdot \\
C & \mdash\mintra\mdot\mintra\mdash\mintra\mdot\mintra\mdash \\
D & \mdash\mintra\mdot\mintra\mdot \\
E & \mdot \\
F & \mdot\mintra\mdot\mintra\mdash\mintra\mdot \\
G & \mdash\mintra\mdash\mintra\mdot \\
H & \mdot\mintra\mdot\mintra\mdot\mintra\mdot \\
I & \mdot\mintra\mdot \\
J & \mdot\mintra\mdash\mintra\mdash\mintra\mdash \\
K & \mdash\mintra\mdot\mintra\mdash \\
L & \mdot\mintra\mdash\mintra\mdot\mintra\mdot \\
M & \mdash\mintra\mdash \\
N & \mdash\mintra\mdot \\
O & \mdash\mintra\mdash\mintra\mdash \\
P & \mdot\mintra\mdash\mintra\mdash\mintra\mdot \\
Q & \mdash\mintra\mdash\mintra\mdot\mintra\mdash \\
R & \mdot\mintra\mdash\mintra\mdot \\
S & \mdot\mintra\mdot\mintra\mdot
\end{tabular}
\end{minipage}
\begin{minipage}{0.3\textwidth}
\begin{tabular}{@{}l l@{}}
T & \mdash \\
U & \mdot\mintra\mdot\mintra\mdash \\
V & \mdot\mintra\mdot\mintra\mdot\mintra\mdash \\
W & \mdot\mintra\mdash\mintra\mdash \\
X & \mdash\mintra\mdot\mintra\mdot\mintra\mdash \\
Y & \mdash\mintra\mdot\mintra\mdash\mintra\mdash \\
Z & \mdash\mintra\mdash\mintra\mdot\mintra\mdot \\
& \\
& \\
1 & \mdot\mintra\mdash\mintra\mdash\mintra\mdash\mintra\mdash\mintra \\
2 & \mdot\mintra\mdot\mintra\mdash\mintra\mdash\mintra\mdash\mintra \\
3 & \mdot\mintra\mdot\mintra\mdot\mintra\mdash\mintra\mdash\mintra \\
4 & \mdot\mintra\mdot\mintra\mdot\mintra\mdot\mintra\mdash\mintra \\
5 & \mdot\mintra\mdot\mintra\mdot\mintra\mdot\mintra\mdot\mintra \\
6 & \mdash\mintra\mdot\mintra\mdot\mintra\mdot\mintra\mdot\mintra \\
7 & \mdash\mintra\mdash\mintra\mdot\mintra\mdot\mintra\mdot\mintra \\
8 & \mdash\mintra\mdash\mintra\mdash\mintra\mdot\mintra\mdot\mintra \\
9 & \mdash\mintra\mdash\mintra\mdash\mintra\mdash\mintra\mdot\mintra \\
0 & \mdash\mintra\mdash\mintra\mdash\mintra\mdash\mintra\mdash\mintra
\end{tabular}
\end{minipage}
...
for tree={
  ...
  edge={},
  scale=0.9,
  if n=1{ edge={dashed, line width=0.6pt}}{edge={dotted, line width=1.2pt}},
}
[{}, draw, circle, minimum size=4pt, inner sep=0pt, edge={dashed, line width=0.6pt}
  [T
    [M
      [O]
      [G [Q] [Z]]
...
% [{}, draw, circle, minimum size=4pt, inner sep=0pt
%   [T
%     [M
%       [O [[8] [9]] [[,phantom] [0]]]
%       [G [Q] [Z [7] [,phantom]]]
...
% Using regex to translate text in capital letters:

% onece (this is a singular space in the search parameters)
%   to \mword
% twice
% ([A-Z])([A-Z]) to $1\minter$2
...
% For existing morse code in . and -, words separated by double space and letters by singular
% once
%    to \mword
% once
%   to \minter
